<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Phukien.aspx.cs" Inherits="BTL.Phukien" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <meta charset="utf-8" />
    <title></title>
    <link href="~/Assets/Css/phukien.css" type="text/css" rel="stylesheet" runat="server"/>
...
<body>
    ...
    <div class="banner">
        <img src="Assets/Images/slidepk2.jpg" class="banner"/>
    </div>
    <div class="contents-menu">
        <div class="contents-menu-left">
            ...
            <p>Balo nữ</p>
            <p>Combo túi ví nữ</p>
            <p>Túi nữ theo thương hiệu</p>
            <p><b>Ví nam</b></p>
            <p>Ví nam bỏ túi</p>
            <p>Ví nam cầm tay</p>
            <p><b>Ví nữ</b></p>
            <p>Ví nữ dự tiệc</p>
            <p><b>Dây lưng nam</b></p>
            <p><b>Dây lưng nữ</b></p>
            <p><b>Khăng quàng</b></p>
            <p><b>Mũ nón</b></p>
            <p><b>Găng tay nữ</b></p>
        ...
        <div class="contents-menu-right">
            <img src="Assets/Images/c19d0f043b7c2b8b6c226eb1188415a4db00272d.jpeg"  class="anhdep"/>
            <div class="contents-menu-right-under">
                <div id="rightunder" runat="server">
    ...
    <button id="btnHead" onclick="document.location.href='#logo';"><i class="fas fa-chevron-up"></i></button>
     ...
     <%--/*var x = confirm("Có muốn xóa sản phẩm không!");
            if (x) {
